@extends('views.admin.layout._Master')
...
@section('Content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">{{ __('admin.member.list_title',["Attribute"=>"我是範本I am"]) }}</h1>
                </div>
                <div class="col-sm-6">
                                        ...
                                        <div class="card card-primary">
                                            <div class="card-header">
                                                ...
                                                <div class="card-tools">
                                                    <a class="btn btn-sm btn-primary" href="/operate/Member_Data/0">新增</a>
                                                    <button class="btn btn-sm btn-warning">匯入</button>
                                                    <a class="btn btn-sm btn-warning"
                                                       href="/operate/Member_Data/export?{{request()->getQueryString()}}"
                                                       target="_blank">匯出</a>
                                                </div>
                                            </div>
