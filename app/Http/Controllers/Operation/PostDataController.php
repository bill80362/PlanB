...
class PostDataController extends Controller
{
    ...
    public function listHTML(ListColumnService $listColumnService)
    {
        ...
        // @todo 
        return view('operate/pages/post_data/list', [
            'Paginator' => $Paginator,            
            'Model' => $this->oModel,
            'columns' => $userColumns,
    ...
    public function updateHTML($id)
    {
        ...
        //View
        return view('operate/pages/post_data/update', [
            'Data' => $Data,                        
            'Model' => $this->oModel,
        ]);
    }
    ...
    public function update($id)
    {
        ...
        return redirect("/operate/post_data?" . $this->request->getQueryString())->with(['success' => __('送出成功')]);
    }
    ...
    public function delBatch()
    {
        ...
        return redirect("/operate/post_data?" . $this->request->getQueryString())->with(['success' => __('刪除成功')]);
    }
    ...
    public function import()
    {
        ...
        try {
            ...
            return redirect("/operate/post_data?" . $this->request->getQueryString())->with(['error' => $e->getMessage()]);
        }
        //有錯誤
        if ($AllMessage) {
    ...
    public function export($Type)
    {
        ...
        //匯出
        return (new Collection($ExportList))->downloadExcel('post_data_data_' . time() . '.xlsx');
    }
    ...
    public function audit($id)
    {
        ...
        return view('operate/pages/post_data/audit', [
            'Paginator' => $Paginator,            
            'Model' => $this->oModel,
        ]);
    }
